...
const ItemPke = (props) => {
    ...
    const getId = () => props.pokemon.url.split("/")[6];
    useEffect(() => {
        getPokemons();
    }, []);
            ...
            <Card style={{flex:1, padding: 10, margin: 5, width: '90%', height: 400 }}>
                ...
                <View style={styles.buttons}>
                    <Icon onPress={() =>
                        ...
                        Alert.alert('Actualizado', (props.msg?"El pokemon fue eliminado correctamente":"El pokemon fue agregado correctamente"), [
                            {
                                text: 'OK',
                        ...
                        name={(props.msg?"trash-sharp":"person-add-sharp")} size={13} color='#000'>
